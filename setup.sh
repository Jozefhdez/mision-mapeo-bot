...
echo "📦 Descargando modelo Llama 3.1 8B (esto puede tardar varios minutos)..."
docker exec -it mision-mapeo-ollama ollama pull llama3.1:8b

echo ""
echo "🏗️  Construyendo imagen del bot..."
...
echo ""
echo "🤖 ¡Tu bot está listo! Envíale un mensaje en Telegram."
